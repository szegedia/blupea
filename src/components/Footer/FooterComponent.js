...
import { mdiEmail, mdiFacebook, mdiPhone, mdiPinterest } from "@mdi/js";
...
const FooterComponent = () => {
  return (
    <section className="flex flex-col justify-center items-center pt-20">
      <div className="flex">
        <a
          href="https://www.facebook.com/blupea.interior/"
          target="_blank"
          rel="noreferrer"
        >
          <Icon path={mdiFacebook} size="1.75rem" className="mx-4" />
        </a>

        <a
          href="https://www.pinterest.com/blupea_interior"
          target="_blank"
          rel="noreferrer"
        >
          <Icon path={mdiPinterest} size="1.75rem" className="mx-4" />
        </a>

        <a
          href="https://www.behance.net/blupea"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a href="mailto:info@blupea.hu">
          <Icon path={mdiEmail} size="1.75rem" className="mx-4" />
        </a>

        <a href="tel:+36401234567">
          <Icon path={mdiPhone} size="1.75rem" className="mx-4" />
        </a>
      </div>
      <div className="py-8 text-xs">Minden jog fenntarva.</div>
    </section>
  );
};
